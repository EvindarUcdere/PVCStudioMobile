...
const sampleStockItems: SaveStockItemInput[] = [
  ...
  {
    id: 'sample-stock-roller-shutter-box',
    name: 'Ustten panjur kutusu',
    type: 'roller_shutter',
    quantity: 12,
    unit: 'piece',
    minimumQuantity: 3,
    purchasePrice: 2400,
    notes: 'Pencere ustu panjur alani testleri icin.',
  },
  {
    id: 'sample-stock-insect-screen-fixed',
    name: 'Sabit sineklik',
    type: 'insect_screen',
    quantity: 20,
    unit: 'piece',
    minimumQuantity: 5,
    purchasePrice: 420,
    notes: 'Acilir kanatlar icin sabit sineklik.',
  },
  {
    id: 'sample-stock-insect-screen-sliding',
    name: 'Surgulu sineklik',
    type: 'insect_screen',
    quantity: 14,
    unit: 'piece',
    minimumQuantity: 4,
    purchasePrice: 680,
    notes: 'Saga/sola veya yukari surme sineklik denemesi.',
  },
  {
